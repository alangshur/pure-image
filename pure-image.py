...
try:
    ...
    features_harris = feature.FEAlgorithms.get_harris_corner(feature_extractor.img_np)
    features_shi = feature.FEAlgorithms.get_shi_tomasi_corner(feature_extractor.img_np)
    features_fast = feature.FEAlgorithms.get_FAST_corner(feature_extractor.img_gs)
    features_sift = feature.FEAlgorithms.get_SIFT_keypoint(feature_extractor.img_gs)
    features_surf = feature.FEAlgorithms.get_SURF_keypoint(feature_extractor.img_gs)
    features_kaze = feature.FEAlgorithms.get_KAZE_keypoint(feature_extractor.img_gs)
    features_akaze = feature.FEAlgorithms.get_AKAZE_keypoint(feature_extractor.img_gs)
    features_brisk = feature.FEAlgorithms.get_BRISK_keypoint(feature_extractor.img_gs)
    features_brief = feature.FEAlgorithms.get_BRIEF_keypoint(feature_extractor.img_gs)
    features_orb = feature.FEAlgorithms.get_ORB_keypoint(feature_extractor.img_gs)
